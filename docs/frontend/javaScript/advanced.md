...
<img :src="$withBase('/image/javascript/pro.png')" alt="">
...
<img :src="$withBase('/image/javascript/proto.png')" alt="">
<img :src="$withBase('/image/javascript/proto2.png')" alt="">
